...
<head>
    ...
    <title>Product API API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-gestao-de-produtos" class="tocify-header">
                <li class="tocify-item level-1" data-unique="gestao-de-produtos">
                    <a href="#gestao-de-produtos">Gestão de Produtos</a>
                </li>
                                    <ul id="tocify-subheader-gestao-de-produtos" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="gestao-de-produtos-GETapi-v1-products">
                                <a href="#gestao-de-produtos-GETapi-v1-products">Listar Produtos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestao-de-produtos-POSTapi-v1-products">
                                <a href="#gestao-de-produtos-POSTapi-v1-products">Criar Produto
* Cria um novo registro de produto no banco de dados.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestao-de-produtos-GETapi-v1-products--id-">
                                <a href="#gestao-de-produtos-GETapi-v1-products--id-">Visualizar Produto
* Retorna os detalhes de um produto específico através do ID.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestao-de-produtos-PUTapi-v1-products--id-">
                                <a href="#gestao-de-produtos-PUTapi-v1-products--id-">Atualizar Produto
* Atualiza as informações de um produto existente.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestao-de-produtos-DELETEapi-v1-products--id-">
                                <a href="#gestao-de-produtos-DELETEapi-v1-products--id-">Excluir Produto
* Remove permanentemente um produto do catálogo.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="gestao-de-produtos">Gestão de Produtos</h1>

    <p>Endpoints para gerenciar o catálogo de produtos, incluindo estoque e filtragem.</p>

                                <h2 id="gestao-de-produtos-GETapi-v1-products">Listar Produtos</h2>

<p>
</p>

<p>Retorna uma lista paginada de produtos com filtros aplicáveis.</p>
<ul>
<li>@queryParam search string Termo para busca no nome ou descrição. Example: iPhone</li>
</ul>
...
<div class="bash-example">
    ...
    --get "http://localhost:8080/api/v1/products?category=electronics&amp;is_active=1&amp;page=1&amp;per_page=10" \
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filtrar por categoria. Example: <code>electronics</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filtrar por status. Example: <code>true</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Itens por página. Example: <code>10</code></p>
            </div>
                </form>

                    <h2 id="gestao-de-produtos-POSTapi-v1-products">Criar Produto
* Cria um novo registro de produto no banco de dados.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nome do produto. Example: <code>iPhone 15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Preço unitário. Example: <code>4999.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Quantidade em estoque. Example: <code>10</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
"data": { "id": 1, "name": "iPhone 15", "price": 4999.99, "stock": 10, "category": "electronics" }
               ...
               data-component="body">
    <br>
<p>Categoria do produto. Example: `electronics</p>
<ul>
<li>@response 201 {
"status": "success",
"message": "Produto criado com sucesso.",
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="gestao-de-produtos-GETapi-v1-products--id-">Visualizar Produto
* Retorna os detalhes de um produto específico através do ID.</h2>

<p>
</p>

<ul>
<li>@urlParam id int required O ID do produto. Example: 1</li>
<li>@response 200 {
"status": "success",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/products/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/products/architecto"
);
...
<p>The ID of the product. Example: <code>architecto</code></p>
                    ...
                    <h2 id="gestao-de-produtos-PUTapi-v1-products--id-">Atualizar Produto
* Atualiza as informações de um produto existente.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nome do produto. Example: <code>iPhone 15 Pro</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Preço unitário. Example: <code>5999.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>stock</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve ter um valor superior ou igual a 0. Example: <code>42</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>livros</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>eletronicos</code></li> <li><code>vestuario</code></li> <li><code>alimentos</code></li> <li><code>moveis</code></li> <li><code>livros</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>is_active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="gestao-de-produtos-DELETEapi-v1-products--id-">Excluir Produto
* Remove permanentemente um produto do catálogo.</h2>
